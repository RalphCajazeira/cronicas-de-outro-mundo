...
Não existe operação atual para gastar/curar recursos, aplicar dano, resolver combate, usar consumível, comprar/vender, aplicar loot automático, relacionamento especializado, memória especializada, Codex, viagem ou checkpoint. Knowledge pode orientar a narrativa desses temas, mas não pode transformá-los em persistência estruturada.
